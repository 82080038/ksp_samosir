...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="page-header">
    <h1 class="h2 page-title" id="page-title" style="color: black;" data-page="simpanan-create">Tambah Simpanan</h1>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Page simpanan - create initialized');
    
    // Update page title dynamically
    if (typeof updatePageTitle !== 'undefined') {
        updatePageTitle('Tambah Simpanan', 'simpanan-create');
    }
});
