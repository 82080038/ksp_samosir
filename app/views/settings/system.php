...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="page-header">
    <h1 class="h2 page-title" id="page-title" style="color: black;" data-page="settings-system">Pengaturan Sistem</h1>
 ...
 * Enhanced settings page based on KSP-PEB system-settings.php
 */
...
$systemInfo = $systemConfig->getSystemInfo();
?>
