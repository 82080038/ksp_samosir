...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="page-header">
    <h1 class="h2 page-title" id="page-title" style="color: black;" data-page="shu-reports">Laporan SHU</h1>
                ...
                <tbody>
                    <?php foreach ($members as $member): ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $dist_count = (fetchRow("SELECT COUNT(*) as count FROM member_shu WHERE member_id = ?", [$member['id']], 'i') ?? [])['count'] ?? 0;
                                echo $dist_count;
                                ?>
                            </td>
                            <td>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                $total_shu_all = (fetchRow("SELECT COALESCE(SUM(total_shu), 0) as total FROM member_shu") ?? [])['total'] ?? 0;
                $avg_shu = $total_members > 0 ? $total_shu_all / $total_members : 0;
                $paid_shu = (fetchRow("SELECT COALESCE(SUM(total_shu), 0) as total FROM member_shu WHERE status_pembayaran = 'lunas'") ?? [])['total'] ?? 0;
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Page shu - reports initialized');
    
    // Update page title dynamically
    if (typeof updatePageTitle !== 'undefined') {
        updatePageTitle('Laporan', 'shu-reports');
    }
});
