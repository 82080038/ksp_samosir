...
$user = getCurrentUser();
$role = $user['role'] ?? null;
$stats = $stats ?? ['total_employees' => 0, 'total_salary_paid_month' => 0, 'pending_payrolls' => 0, 'total_payrolls_this_month' => 0];
?>

<!-- Page Header -->
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="page-header">
    <h1 class="h2 page-title" id="page-title" style="color: black;" data-page="payroll">Penggajian</h1>
